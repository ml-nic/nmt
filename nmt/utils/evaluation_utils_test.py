...
class EvaluationUtilsTest(tf.test.TestCase):
    ...
    def testAccuracy(self):
        ...
        accuracy_score = evaluation_utils.evaluate(
            label_ref, pred_output, "old_accuracy")
    ...
    def testAccuracyNew(self):
        self.assertAlmostEqual(2.2, evaluation_utils.evaluate("../../Data/SQA2018/dev.tok.sparql",
                                                              "../../Data/SQA2018/baseline_attention_normed_bahdanau_model/output_dev",
                                                              "accuracy"))
        self.assertAlmostEqual(2.0, evaluation_utils.evaluate("../../Data/SQA2018/dev.tok.sparql",
                                                              "../../Data/SQA2018/baseline_attention_normed_bahdanau_model/output_dev",
                                                              "old_accuracy"))

        self.assertAlmostEqual(100.0, evaluation_utils.evaluate("../../Data/SQA2018/dev.tok.sparql",
                                                                "../../Data/SQA2018/dev.tok.sparql",
                                                                "accuracy"))
        self.assertAlmostEqual(100.0, evaluation_utils.evaluate("../../Data/SQA2018/dev.tok.sparql",
                                                                "../../Data/SQA2018/dev.tok.sparql",
                                                                "old_accuracy"))
