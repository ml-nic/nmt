...
def create_vocab_tables(src_vocab_file, tgt_vocab_file, share_vocab, sent_feat_vocab_file=None):
    ...
    if sent_feat_vocab_file:
        sent_feat_vocab_table = lookup_ops.index_table_from_file(
            sent_feat_vocab_file, default_value=UNK_ID)
    return src_vocab_table, tgt_vocab_table, sent_feat_vocab_table
