...
def add_arguments(parser):
    ...
    parser.add_argument("--sent_feat_max_len", type=int, default=1,
                        help="Max length of tgt sequences during training.")
    parser.add_argument("--sent_feat_max_len_infer", type=int, default=None,
...
def extend_hparams(hparams):
    ...
    if hparams.sent_feature_file_path:
        ...
        hparams.add_hparam("sent_feat_vocab_file", sent_feat_vocab_file)
