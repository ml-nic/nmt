...
def add_arguments(parser):
    ...
    parser.add_argument("--generator", type="bool", default=False,
                        help="Whether to use the data which was generated with the generator.")
...
def create_hparams(flags):
    ...
    return tf.contrib.training.HParams(
        ...
        sent_feat_vocab_file=flags.sent_feat_vocab_file,
    )
...
def extend_hparams(hparams):
    ...
    # Sentenece Feature Vocab File
    if hparams.sent_feature_file:
        sent_feat_vocab_size, sent_feat_vocab_file = vocab_utils.check_vocab(
            hparams.sent_feat_vocab_file,
            hparams.out_dir,
            sos=hparams.sos,
            eos=hparams.eos,
            unk=vocab_utils.UNK)

        hparams.add_hparam("sent_feat_vocab_size", sent_feat_vocab_size)
...
def main(unused_argv):
    if FLAGS.generator is True:
        FLAGS.vocab_prefix = FLAGS.vocab_prefix + "_generator"
        FLAGS.train_prefix = FLAGS.train_prefix + "_generator"
