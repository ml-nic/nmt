...
class BaseModel(object):
    ...
    def __init__(self,
        ...
        self.sent_feat_vocab_table = sent_feat_vocab_table
    ...
    def _get_learning_rate_decay(self, hparams):
        ...
        if hparams.decay_scheme in ["luong5", "luong10", "luong234"] or hparams.decay_scheme.startswith("early"):
            decay_factor = 0.5
    ...
    def init_embeddings(self, hparams, scope):
        """Init embeddings."""
        self.embedding_encoder, self.embedding_decoder, self.sent_feat_embedding_encoder = (
            model_helper.create_emb_for_encoder_and_decoder_and_sent_feat_encoder(
                share_vocab=hparams.share_vocab,
                src_vocab_size=self.src_vocab_size,
                tgt_vocab_size=self.tgt_vocab_size,
                sent_feat_vocab_size=self.sent_feat_vocab_size,
                src_embed_size=hparams.num_units,
                tgt_embed_size=hparams.num_units,
                sent_feat_embed_size=hparams.num_units,
        ...
        with tf.variable_scope("encoder") as scope:
            ...
            if hparams.encoder_type == "uni":
                ...
                encoder_outputs, encoder_state = tf.nn.dynamic_rnn(
                    cell,
                    concated_encoder_emb_inp,
                    dtype=dtype,
                    sequence_length=iterator.source_sequence_length + 100,
                    time_major=self.time_major,
                    swap_memory=True)
                ...
                encoder_outputs, bi_encoder_state = (
                    self._build_bidirectional_rnn(
                        inputs=concated_encoder_emb_inp,
                        sequence_length=iterator.source_sequence_length + 100,
                        dtype=dtype,
                        hparams=hparams,
