...
__all__ = [
    ...
    "create_emb_for_encoder_and_decoder_and_sent_feat_encoder", "create_rnn_cell", "gradient_clip",
...
def create_train_model(
    ...
    with graph.as_default(), tf.container(scope or "train"):
        src_vocab_table, tgt_vocab_table, sent_feat_vocab_table = vocab_utils.create_vocab_tables(
            src_vocab_file, tgt_vocab_file, hparams.share_vocab, sent_feat_vocab_file=sent_feat_vocab_file)
        ...
        iterator = iterator_utils.get_iterator(
            ...
            shard_index=jobid,
            sent_feat_dataset=sent_feat_dataset,
            sent_feat_vocab_table=sent_feat_vocab_table,
            sent_feat_max_len=hparams.sent_feat_max_len)
...
class EvalModel(
    collections.namedtuple("EvalModel",
                           ("graph", "model", "src_file_placeholder",
                            "tgt_file_placeholder", "iterator", "sent_feat_file_placeholder"))):
    pass
...
def create_eval_model(model_creator, hparams, scope=None, extra_args=None):
    ...
    with graph.as_default(), tf.container(scope or "eval"):
        ...
        iterator = iterator_utils.get_iterator(
            ...
            sent_feat_dataset=sent_feat_dataset,
            sent_feat_vocab_table=sent_feat_vocab_table,
            sent_feat_max_len=hparams.sent_feat_max_len_infer)
        model = model_creator(
            hparams,
            iterator=iterator,
    ...
    return EvalModel(
        ...
        iterator=iterator,
        sent_feat_file_placeholder=sent_feat_file_placeholder)


class InferModel(
    collections.namedtuple("InferModel",
                           ("graph", "model", "src_placeholder",
                            "batch_size_placeholder", "iterator", "sent_feat_placeholder"))):
    pass
...
def create_infer_model(model_creator, hparams, scope=None, extra_args=None):
    ...
    return InferModel(
        ...
        iterator=iterator,
        sent_feat_placeholder=sent_feat_placeholder)
...
def create_emb_for_encoder_and_decoder_and_sent_feat_encoder(share_vocab,
                                                             src_vocab_size,
                                                             tgt_vocab_size,
                                                             src_embed_size,
                                                             tgt_embed_size,
                                                             ...
                                                             tgt_embed_file=None,
                                                             scope=None,
                                                             sent_feat_vocab_size=None,
                                                             sent_feat_embed_size=None,
                                                             sent_feat_vocab_file=None,
                                                             sent_feat_embed_file=None):
    ...
    with tf.variable_scope(
        ...
        sent_feat_embedding_encoder = None
        # Share embedding
        if share_vocab:
            ...
            if sent_feat_vocab_size:
                sent_feat_embedding_encoder = _create_or_load_embed("sent_feat_embedding_encoder",
                                                                    sent_feat_vocab_file, sent_feat_embed_file,
                                                                    sent_feat_vocab_size, sent_feat_embed_size, dtype)
        else:
            with tf.variable_scope("encoder", partitioner=partitioner):
                ...
                if sent_feat_vocab_size:
                    sent_feat_embedding_encoder = _create_or_load_embed("sent_feat_embedding_encoder",
                                                                        sent_feat_vocab_file, sent_feat_embed_file,
                                                                        sent_feat_vocab_size, sent_feat_embed_size,
                                                                        dtype)
    ...
    return embedding_encoder, embedding_decoder, sent_feat_embedding_encoder
