...
def run_sample_decode(infer_model, infer_sess, model_dir, hparams,
    ...
    _sample_decode(loaded_infer_model, global_step, infer_sess, hparams,
                   ...
                   sent_feat_data=sent_feat_data,
                   sent_feat_placeholder=infer_model.sent_feat_placeholder)
...
def run_external_eval(infer_model, infer_sess, model_dir, hparams,
    ...
    if hparams.sent_feature_file:
        ...
        dev_infer_iterator_feed_dict = {
            ...
            infer_model.sent_feat_placeholder: sent_feat_placeholder
        }
    else:
        dev_infer_iterator_feed_dict = {
            infer_model.src_placeholder: inference.load_data(dev_src_file),
    ...
    if use_test_set and hparams.test_prefix:
        ...
        test_infer_iterator_feed_dict = {
            ...
            infer_model.batch_size_placeholder: hparams.infer_batch_size,
            infer_model.sent_feat_placeholder: test_sent_feat_file
        }
...
def run_full_eval(model_dir, infer_model, infer_sess, eval_model, eval_sess,
                  ...
                  sample_sent_feat_data, avg_ckpts=False):  # TODO may sample_sent_feat_data optional
...
def train(hparams, scope=None, target_session=""):
    ...
    run_full_eval(
        ...
        sample_tgt_data, sample_sent_feat_data, avg_ckpts=avg_ckpts)
    ...
    (result_summary, _, final_eval_metrics) = (
        run_full_eval(
            ...
            summary_writer, sample_src_data, sample_tgt_data, sample_sent_feat_data, avg_ckpts=avg_ckpts))
    ...
    for metric in hparams.metrics:
        ...
        if avg_ckpts:
            ...
            result_summary, best_global_step, _ = run_full_eval(
                ...
                hparams, summary_writer, sample_src_data, sample_tgt_data, sample_sent_feat_data)
...
def _sample_decode(model, global_step, sess, hparams, iterator, src_data,
                   ...
                   sent_feat_data=None, sent_feat_placeholder=None):
