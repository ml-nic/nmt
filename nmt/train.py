...
def run_sample_decode(infer_model, infer_sess, model_dir, hparams,
                      ...
                      sent_feat_data):  # TODO: if it work, make sent_feat_data optional with default = None
    ...
    _sample_decode(loaded_infer_model, global_step, infer_sess, hparams,
                   ...
                   sent_feat_data=sent_feat_data, sent_feat_placeholder=infer_model.sent_feat_placeholder)
...
def run_internal_eval(
    ...
    if hparams.sent_feature_file:
        ...
        dev_eval_iterator_feed_dict = {
            ...
            eval_model.sent_feat_file_placeholder: dev_sent_feat_file
        }
    else:
        dev_eval_iterator_feed_dict = {
            eval_model.src_file_placeholder: dev_src_file,
    ...
    if hparams.test_prefix:
        ...
        test_sent_feat_file = None
        if hparams.sent_feature_file:
            test_sent_feat_file = hparams.sent_feature_file
        test_eval_iterator_feed_dict = {
            eval_model.src_file_placeholder: test_src_file,
            eval_model.tgt_file_placeholder: test_tgt_file,
            eval_model.sent_feat_file_placeholder: test_sent_feat_file
        }
...
def run_external_eval(infer_model, infer_sess, model_dir, hparams,
    ...
    if hparams.sent_feature_file:
        fill_sent_placeholder = inference.load_data(hparams.sent_feature_file)

        dev_infer_iterator_feed_dict = {
            infer_model.src_placeholder: inference.load_data(dev_src_file),
            infer_model.batch_size_placeholder: hparams.infer_batch_size,
            infer_model.sent_feat_placeholder: fill_sent_placeholder
        }
    else:
        dev_infer_iterator_feed_dict = {
            infer_model.src_placeholder: inference.load_data(dev_src_file),
...
def run_full_eval(model_dir, infer_model, infer_sess, eval_model, eval_sess,
                  ...
                  sample_sent_feat_data):  #TODO may sample_sent_feat_data optional
    """Wrapper for running sample_decode, internal_eval and external_eval."""
    run_sample_decode(infer_model, infer_sess, model_dir, hparams, summary_writer,
                      sample_src_data, sample_tgt_data, sample_sent_feat_data)
...
def train(hparams, scope=None, target_session=""):
    ...
    dev_tgt_file = "%s.%s" % (hparams.dev_prefix, hparams.tgt)
    dev_sent_feat_file = hparams.sent_feature_file
    #TODO: fix dev_sent_feature_file_everywhere maybe just do with prefix/sufix like src tgt, then automatic error
...
def _sample_decode(model, global_step, sess, hparams, iterator, src_data,
                   ...
                   iterator_batch_size_placeholder, summary_writer, sent_feat_data=None, sent_feat_placeholder=None):
    ...
    if hparams.sent_feature_file:
        iterator_feed_dict = {
            ...
            sent_feat_placeholder: [sent_feat_data[decode_id]]
        }
    else:
        iterator_feed_dict = {
            iterator_src_placeholder: [src_data[decode_id]],
